...
class DualBranchContrast(torch.nn.Module):
    ...
    def forward(self, h1=None, h2=None, g1=None, g2=None, batch=None, h3=None, h4=None,
        ...
        l1_mean, l1 = self.loss(anchor=anchor1, sample=sample1, pos_mask=pos_mask1, neg_mask=neg_mask1, **self.kwargs)
        l2_mean, l2 = self.loss(anchor=anchor2, sample=sample2, pos_mask=pos_mask2, neg_mask=neg_mask2, **self.kwargs)

        return (l1_mean + l2_mean) * 0.5, (l1 + l2) * 0.5
