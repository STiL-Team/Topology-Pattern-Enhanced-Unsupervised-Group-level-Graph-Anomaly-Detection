...
class SubEvaluator(BaseEvaluator):
    ...
    def evaluate(self, x: torch.FloatTensor, y: torch.LongTensor, split: dict):
        ...
        with tqdm(total=self.num_epochs, desc='(LR)',
            ...
            for epoch in range(self.num_epochs):
                ...
                if (epoch + 1) % self.test_interval == 0:
                    ...
                    y_val_pred = classifier(x[split['valid']]).argmax(-1).detach().cpu().numpy()
        ...
        return {
            ...
            'test': best_pred_test[0],
            'pred': best_pred_test[1]
        }
